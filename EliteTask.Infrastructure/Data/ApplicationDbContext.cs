...
namespace EliteCompanyTask.Domain.Entities;
...
public partial class ApplicationDbContext : DbContext
{
    ...
    {
        modelBuilder.Entity<AccountBalanceHistoryResultDto>().HasNoKey();
        ...
        modelBuilder.Entity<BalanceHistory>(entity =>
        {
            ...
            entity.HasIndex(e => e.Date, "IX_Balance_CreatedDate");
            ...
            entity.HasOne(d => d.Balance).WithMany(p => p.BalanceHistories)
                .HasForeignKey(d => d.BalanceId)
                .HasConstraintName("FK_BalanceHistory_Balance");
        });
